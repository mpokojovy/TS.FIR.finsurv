...
function plot_raw_prices(dates, log_diffs, ref_date, plot_title)
    figure;
    ...
    plot(dates, log_diffs, '-', 'LineWidth', 2, 'Color', color_order(1, :));
    xline(ref_date);

    title(plot_title, 'interpreter', 'latex', 'FontSize', 18);

    xlabel('Date', 'interpreter', 'latex', 'FontSize', 18);
    ylabel('Closing price log-difference', 'interpreter', 'latex', 'FontSize', 18);
end